...
public class FloatingDatePicker: UIView {
    ...
    private func setupDateTextFeild() {
        txtDate.textColor = UIColor.init(hex: "172651")
//        txtDate.tintColor = UIColor(red: 0.086, green: 0.149, blue: 0.318, alpha: 0.6)
//        txtDate.filledTextColor = UIColor(red: 0.086, green: 0.149, blue: 0.318, alpha: 0.6)
//        txtDate.font = UIFont(name: FontName.medium.rawValue, size: Utils.shared.setFontSizeAsPerDeviceHeight(currentSize: FontSize.size_16))
    }
    ...
    private func didUpdateDate() {
        ...
        self.calendarImageView.tintColor = UIColor.init(hex: "5367FC")
    ...
    public func didFirstEmpty() {
        ...
        self.calendarImageView.tintColor = UIColor.gray
        txtDate.text = ""
    ...
    @IBAction private func dateChangedAction(_ sender: UIDatePicker) {
        ...
        self.calendarImageView.tintColor = UIColor.blue

...
class FloatLabelTextView: UITextView {
	...
	deinit {
		if !isIB {
            ...
            nc.removeObserver(self, name: UITextField.textDidChangeNotification, object:self)
            nc.removeObserver(self, name: UITextField.textDidBeginEditingNotification, object:self)
            nc.removeObserver(self, name: UITextField.textDidEndEditingNotification, object:self)
        }
	}
	...
	fileprivate func setup() {
		...
		if !isIB {
			let nc = NotificationCenter.default
			nc.addObserver(self, selector:#selector(UIView.layoutSubviews), name: UITextField.textDidChangeNotification, object:self)
			nc.addObserver(self, selector:#selector(UIView.layoutSubviews), name: UITextField.textDidBeginEditingNotification, object:self)
			nc.addObserver(self, selector:#selector(UIView.layoutSubviews), name: UITextField.textDidEndEditingNotification, object:self)
		}
	}
